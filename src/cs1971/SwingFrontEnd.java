...
/**
 * An implementation of {@link CS1971FrontEnd} that uses Swing/AWT for drawing and events.
 * <br><br>
 * To use, create a subclass that overrides the various <code>on</code>*** methods of CS1971FrontEnd
 * and call {@link #startup()} to begin processing events.
 * 
 * @author zdavis
 */
public abstract class SwingFrontEnd extends CS1971FrontEnd {
	/**
